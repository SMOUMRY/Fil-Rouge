...
<body class="bg-light">
  ...
  <main>
    ...
    <div class="col-12 validate">
      <span class="total">Total du panier : <?= $totalPrice ?>€</span>
      <button type="submit" class="cart-item btn btn-primary sub"><span class="bi bi-cart"></span>Validé</button>
    </div>
    </form>
    <p class="test"></p>
  </main>
